...
import { Globe, LogOut, Shield, Info, User } from 'lucide-react';
...
export default function CaregiverSettings() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-2xl font-extrabold text-gray-900 mb-6">{t('settings')}</h1>
      ...
      <div className="card-elderly mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{t('caregiver')}</p>
          </div>
        </div>
      </div>
      ...
      <div className="card-elderly mb-4">
        ...
        <p className="text-sm text-gray-500">Caregiver access is limited to assigned patients only. All data is encrypted and stored locally.</p>
      </div>
      ...
      <div className="card-elderly mb-6">
        ...
        <p className="text-sm text-gray-500 mb-2">MindCare AI v1.0 — SIH26003 Prototype</p>
